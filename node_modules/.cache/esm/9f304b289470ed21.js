let Setting,SettingTimeReportMoDel;_947‍.w("../../models/setting",[["default",["Setting"],function(v){Setting=v}],["SettingTimeReportMoDel",["SettingTimeReportMoDel"],function(v){SettingTimeReportMoDel=v}]]);const { to, ReE, ReS } = require("../../services/util.service");
...
exports.create = async (req,res) =>{
    ...
    const date_parse = parsetimereport(date_now);   
    _947‍.g.console.log(date_parse);
    // try {
    //     // await Report.remove({});
    ...
    //         //set time_report
    //         const date_now = new Date();
    //         const date_report = parsetimereport(date_now);   
